...
public class Menu {
    ...
    public void start() {
        ...
        System.out.println("\uD83D\uDC4B\uD83C\uDFFD WELCOME BACK ANYTIME!\n");
    }
    ...
    private void addInitialCommands() {
        ...
        commands.put(4, options::searchAuthorsAliveInYear);
        commands.put(5, options::searchBooksByLanguage);
    ...
    public void displayOptions() {
        ...
        System.out.println("""
                ...
                4) Search authors alive in a given year
